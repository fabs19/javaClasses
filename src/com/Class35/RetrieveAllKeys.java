...
public class RetrieveAllKeys {
	...
	public static void main(String[] args) {
		...
		Map<String, String> personMap=new LinkedHashMap<>();//->order preserved
		...
		while(keysIterator.hasNext()) {
			...
			String mapKey=keysIterator.next(); //store it into mapkey variable
			String mapValue=personMap.get(mapKey); //store it into mapValue variable
